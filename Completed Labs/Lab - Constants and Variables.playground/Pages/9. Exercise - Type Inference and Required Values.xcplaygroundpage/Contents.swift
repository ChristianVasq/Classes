 ...
 */
var name: String
print("The code does not compile as the String has no value")

/*:
 Now assign a value to `name`, and print it to the console.
 */
var firstName: String = "Julio"
print(firstName)
...
print("No the code will not compile because the number is a decimal.")
