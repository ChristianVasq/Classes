 ...
 */
var Christian = User(userName: "Christian", age: 23, height: 5.10, weight: 190, activityLevel: 12)
print("User:", Christian.userName, "Age:", Christian.age,"Height:", Christian.height,"Weight:", Christian.weight, "Activity Level:", Christian.activityLevel)
 ...
 */
let fity = Distance(meters: 5000.0)
print(fity.feet)
